...
if __name__ == '__main__':
    ...
    parser.add_argument("--datapath", default ='/storage/slurm/xiny/dataset/cofusion/own/dataset')
    ...
    traj_est = droid.terminate(image_stream(args.datapath), need_inv=True, seq_id=seq_id)
