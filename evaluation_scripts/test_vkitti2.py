...
if __name__ == '__main__':
    ...
    parser.add_argument("--datapath", default = '../DeFlowSLAM/datasets/vkitti2/Scene18')
    ...
    parser.add_argument("--trackID", type=int, default=[3])
    ...
    traj_est = droid.terminate(image_stream(args.datapath, args.trackID))
    ...
    traj_ref = PosePath3D(poses_se3=traj_ref[:100])
